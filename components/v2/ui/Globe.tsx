...
declare module "@react-three/fiber" {
  interface ThreeElements {
    threeGlobe: ThreeElements["primitive"];
  }
}
...
export function Globe({ globeConfig, data }: WorldProps) {
  ...
  const globeRef = useRef<any>(new ThreeGlobe()); // keep simple, avoids extra typing issues
  ...
  return <primitive ref={globeRef} object={globeRef.current} />;
}
